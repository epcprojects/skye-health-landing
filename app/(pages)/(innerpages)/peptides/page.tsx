"use client";
import { SmallTickIcon, TickIcon } from "@/public/icons";
  ...
  return (
    <>
      ...
      <section className="py-8 lg:py-24">
        <div className="container max-w-360 mx-auto px-4 lg:px-8 flex flex-col gap-8 lg:gap-16">
          <div className="flex flex-col gap-2">
            <p className="text-xl lg:text-2xl leading-[150%] text-gray-800">
            ...
            <p className="text-xl lg:text-[28px] text-gray-800">
          ...
          <div className="flex flex-col gap-6 lg:gap-14">
            <div className="grid grid-cols-1 lg:grid-cols-2  items-center gap-6 lg:gap-16">
              <div className="flex flex-col gap-9">
                ...
                <div className="flex flex-col gap-6">
                  <div className="flex flex-row gap-4.5">
                    ...
                    <p className="text-xl lg:text-2xl text-gray-800 leading-[135%]">
              ...
              <Image src={images.innerImages.PeptideImage} alt={"Peptide"} className="w-full" />
            </div>
            <div className="bg-linear-to-r from-[#EFEFEF] to-[#E3E3E3] rounded-[30px]  py-4 lg:py-7.5 px-4 lg:px-12">
              <div className="grid grid-cols-1 lg:grid-cols-8 items-center gap-4.5">
                <p className="text-3xl lg:text-4xl font-bold text-black lg:col-span-3">
                  Why This Matters to Performance
                </p>
                <p className="text-xl lg:text-2xl text-gray-800 lg:col-span-5">
