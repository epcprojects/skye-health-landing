"use client";
import { CategoryCard, HeroSection, ThemeButton } from "@/app/components";
...
const Page = () => {
  ...
  return (
    <>
      ...
      />
      <section className="py-24 bg-[url('/images/VectorImage.png')] bg-cover bg-no-repeat bg-position-[center_20px]">
        <div className="container max-w-360 mx-auto px-8 flex flex-col gap-18.5">
          <div className="grid grid-cols-2 items-center gap-12">
            <h2 className="text-[64px] font-semibold leading-[120%] tracking-[-2%] text-black ">
              Research-Grade{" "}
        ...
        <div className="container max-w-360 mx-auto px-8 flex flex-col gap-16 ">
          <div className="flex flex-col gap-11">
            <div className="flex flex-col gap-7.5 items-center">
              <h2 className="text-[64px] font-semibold leading-[120%] text-black tracking-[-2%]">
      ...
      <section className="py-24">
        <div className="container max-w-360 mx-auto flex flex-col gap-16">
          <div className="flex flex-col items-center gap-8">
            <h2 className="text-[74px] font-semibold leading-[120%] text-black tracking-[-2%]">
              <span className="text-[#009FFF]">Our Formulation</span>{" "}
              Philosophy.
            </h2>
            <p className="text-gray-800 text-[28px] leading-[150%] text-center">
          ...
          <div className="px-8 flex flex-col gap-3">
            <div className="grid grid-cols-2 gap-3">
              <div className=" bg-linear-to-r from-[#DFD1C5] to-[#FFF6EB] rounded-[30px] px-12.5 pt-12.5 flex flex-col gap-5 relative overflow-hidden">
                <Image
                ...
                <div className="flex flex-col text-black gap-3">
                  <p className="text-4xl font-semibold leading-[140%]">
                    Structural Reliability Comes First
                  </p>
                  <p className="text-[22px] text-gray-800 line-clamp-2 text-ellipsis">
              ...
              <div className="bg-lightblue  rounded-[30px] flex flex-col items-end overflow-hidden">
                <div className="flex flex-col gap-5 px-12.5 pt-12.5">
                  <div className="flex flex-col text-black gap-3 ">
                    <p className="text-4xl font-semibold leading-[140%]">
            ...
            <div className=" pt-12.5 px-16 bg-linear-to-b from-[#F5F7FA] to-[#C3CFE2] rounded-[30px] grid grid-cols-12 items-center gap-6 relative overflow-hidden">
                <div className="flex flex-col gap-5 col-span-7 pb-4">
      ...
      <section className="py-24">
        <div className="container max-w-360 mx-auto px-8">
                 <div className="grid grid-cols-2 items-end gap-12">
                          <div className="flex flex-col gap-6">
                               <p className="text-[64px] font-semibold leading-[120%]  tracking-[-2%] text-black">Our Quality Control System.</p>
                               <Image src={images.innerImages.QualityControlImage} alt={"quality control"}/>
                          </div>
                          <div className="flex flex-col gap-7.5">
                                <div className="flex flex-col gap-6.25">
                                     <div className="flex flex-row gap-4.5">
                                    <TickIcon/>
                                    <p className="text-2xl text-gray-800">High-performance liquid chromatography purification</p>
                                     </div>
                                     <div className="flex flex-row gap-4.5">
                                    <TickIcon/>
                                    <p className="text-2xl text-gray-800">Mass spectrometry identity confirmation</p>
                                     </div>
                                     <div className="flex flex-row gap-4.5">
                                    <TickIcon/>
                                    <p className="text-2xl text-gray-800">Stability and degradation monitoring</p>
                                     </div>
                                     <div className="flex flex-row gap-4.5">
                                    <TickIcon/>
                                    <p className="text-2xl text-gray-800">Contaminant screening protocols</p>
                                     </div>
                                     <div className="flex flex-row gap-4.5">
                                    <TickIcon/>
                                    <p className="text-2xl text-gray-800">Lot-level traceability</p>
                                     </div>
                                </div>
                                <p className="text-gray-800 text-2xl">Every layer of quality control exists for one reason: molecular consistency. Consistency is what allows informed users to build reliable protocols and predictable outcomes.
</p>
                          </div>
                 </div>
        </div>
