...
interface HormoneTreatmentSliderSectionProps {
  Hormonescards: TreatmentSliderItem[];
}

const HormoneTreatmentSliderSection = ({
  Hormonescards,
}: HormoneTreatmentSliderSectionProps) => {
  ...
  const activeHormoneDot = isHormoneEnd
    ? totalHormoneDots - 1
    : Math.min(
        Math.floor(activeHormoneSlide / 2),
        totalHormoneDots - 1,
      );
...
export default HormoneTreatmentSliderSection;