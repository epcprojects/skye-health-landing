      ...
      >
        ...
        <nav className="px-6 py-5 flex flex-row justify-between">
          ...
          <div className="flex items-center flex-row-reverse xl:flex-row gap-2">
            ...
            <Link
              href={"/products"}
              className="rounded-[5px] hidden bg-white hover:bg-primary hover:text-white transition-colors duration-300 py-2 px-5 group font-medium text-sm text-black xl:flex items-center gap-3"
            >
              Get Started{" "}
            </Link>
