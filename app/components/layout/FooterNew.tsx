...
const FooterNew: React.FC<FooterNewProps> = ({ menuItems }) => {
  ...
  return (
    <footer className="sm:px-4 xl:px-0 mt-auto mb-0 pt-8 py-4 lg:py-8">
      <div className="container mx-auto max-w-7xl px:4 xl:px-8">
        <div className="grid px-4 lg:px-0 grid-cols-1  gap gap-x-0 gap-y-4 lg:gap-y-7.5 lg:gap-x-7.5">
          <div className="px-6  lg:order-0 order-2 sm:px-12 pt-6 bg-linear-to-b rounded-3xl from-[#FDFDFD] to-[#E9EAEB] sm:pt-12 gap-5 lg:gap-10 grid grid-cols-1 lg:grid-cols-3">
            <div className="flex flex-col  space-y-7.5 order-2 lg:order-1  ">
            ...
            <div className=" space-y-3.5 lg:space-y-7.5 order-1 lg:order-2">
              <Image
                alt="logo"
                src={Images.layout.logo}
                className="w-50 lg:hidden block"
              />

              <h2 className="font-bold text-base uppercase text-neutral-900">
                Paramount HealthRx
              </h2>

              <ul className="lg:space-y-4 flex-col flex gap-3 lg:gap-0">
