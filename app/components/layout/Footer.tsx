...
useEffect(() => {
  ...
  className={`text-lg text-gray-100 text-center lg:text-start max-w-83.75 ${
    showText ? "animate-[footer-text-up_700ms_ease-out_both]" : "opacity-0"
  }`}
>
  Premium Peptides • Performance Forward. Delivering purity you can trust to
  high-performance individuals globally.
</p>
